 ...
 */
	#Configure::write('App.fullBaseUrl', 'https://aonde.info');
 ...
 */
	Configure::write('Security.salt', 'DauA2hijaSasroYalDwKLAQW9gaC9miaonde');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '1092381120391-0209381078731827389');
