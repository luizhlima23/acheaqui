					...
					<tr>
						...
						<?php 
							echo $this->Html->link(
								...
								array('controller'=>'logradouros', 'action'=>'add'),
	...
	<section class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="panel panel-default">
				...
				<?php echo $this->element('layout/filtros/filter_logradouros'); ?>		
					...
					<table class="table table-striped table-bordered">
						...
						<thead>					
							<tr>
								...
								<th><?php echo $this->Paginator->sort('end_tipo', __('Tipo')); ?></th>
								<th><?php echo $this->Paginator->sort('descricao', __('Descrição')); ?></th>
						...
						<tbody class="searchable">
							<?php foreach ($logradouros as $d): ?>
							<tr>
								<td class="text-center"><?php echo h($d['Logradouro']['id']); ?>&nbsp;</td>
								<td><?php echo h($d['Logradouro']['end_tipo']); ?>&nbsp;</td>
								<td><?php echo h($d['Logradouro']['descricao']); ?>&nbsp;</td>
								<td><?php echo $this->Formatacao->dataHora($d['Logradouro']['modified']); ?>&nbsp;</td>
								<td class="text-center">
								<?php
									$label_status = ($d['Logradouro']['status'])? 'label-default' : 'label-danger';
									echo $this->Html->tag('span',
										$this->Formata->status($d['Logradouro']['status']),
								...
								<?php
									$id = $d['Logradouro']['id'];
									$display = $d['Logradouro']['descricao'];
									...
									$menu = array(
										$ico_list.__('Detalhes') => array('tipo'=>'link', 'url'=>array('controller'=>'logradouros', 'action'=>'view', $id)),
