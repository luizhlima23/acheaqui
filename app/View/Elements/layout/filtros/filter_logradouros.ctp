...
<div class="panel-body">
	<div class="row">
		...
		<div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-3">
			<?php echo $this->Search->input('f_tipo', array('class'=>'form-control', 'type'=>'text', 'placeholder'=>'Tipo'));?>
		</div>
		
		<!-- LOGRADOURO -->
		<div class="form-group col-md-4 col-sm-4">
			<?php echo $this->Search->input('f_desc', array('class'=>'form-control', 'type'=>'text', 'placeholder'=>'Logradouro'));?>
		</div>
