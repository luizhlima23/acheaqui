...
<div class="banners empresa">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<?php if(isset($contratar)): ?>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12">
						<p>Você ainda não contratou o plano do banner básico:</p>
						<?php 
			...
			<section id="sect-edit-banner_basico" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="row">

					<!-- Banner -->
					<div class="form-group col-xs-12 col-sm-6 col-md-6 col-lg-6" style="border:0px solid red">
						<div class="row">
							<?php echo $this->element('forms/form-banner_a', array('dados'=>$this->request->data['BannerA'])); ?>
						</div>
					</div>
