	...
	<section class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="panel panel-default">
				...
				<?php echo $this->element('layout/filtros/filter_log_pesquisas'); ?>
					...
					<table class="table table-striped table-bordered">
						...
						<thead>					
							<tr>
								...
								<th><?php echo $this->Paginator->sort('search_string', __('Pesquisa')); ?></th>
						...
						<tbody class="searchable">
							...
							<tr>
								<td class="text-center"><?php echo h($l['LogPesquisa']['id']); ?>&nbsp;</td>
								<td><?php echo h($l['LogPesquisa']['search_string']); ?>&nbsp;</td>
								<td><?php echo $this->Formatacao->dataHora($l['LogPesquisa']['created']); ?>&nbsp;</td>
								<td><?php echo $this->Formata->status($l['LogPesquisa']['is_mobile'], 2); ?>&nbsp;</td>
								<td><?php echo h($l['User']['nome_completo']); ?>&nbsp;</td>
								<td><?php echo h($l['LogPesquisa']['ip']); ?>&nbsp;</td>
								<td class="actions text-center">
								<?php
									$id = $l['LogPesquisa']['id'];
									$display = $l['User']['nome_completo'];
									echo $this->Html->link('ver detalhes',
										array('controller'=>'log_pesquisas', 'action'=>'view', $id),
