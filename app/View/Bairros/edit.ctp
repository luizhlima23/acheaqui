...
<div class="bairros view">
	...
	<?php if(!empty($this->request->data)): ?>
		...
		<?php 
			$id = $this->request->data['Bairro']['id'];
			$display = $this->request->data['Bairro']['nome'];
		?>
		...
		<div class="col-xs-12 col-sm-12 col-md-12">
			<h2 class="page-header">
				<table width="100%">
					<tr>
						<td width="80%">
						<?php echo $this->Html->link($display, array('controller'=>'bairros', 'action'=>'view', $id)); ?>
						</td>
						<td width="20%">
						</td>
					</tr>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12">
			<div class="well">
			<?php echo $this->element('forms/form-bairro'); ?>
			</div>	
		</div>
	</div>
