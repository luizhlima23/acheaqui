			...
			<h2 class="page-header">
				<table width="100%">
					<tr>
						...
						<?php 
							echo $this->Html->link(
								'<i class="fa fa-plus-square nav-icon"></i>'.'Nova função',
					...
					<table class="table table-striped table-bordered">
						...
						<thead>					
							<tr>
								...
								<th class="text-center"><?php echo $this->Paginator->sort('ordem', __('Ordem')); ?></th>
						...
						<tbody class="searchable">
							...
							<tr>
								<td class="text-center"><?php echo h($d['Role']['id']); ?>&nbsp;</td>
								<td><?php echo h($d['Role']['name']); ?>&nbsp;</td>
								<td><?php echo h($d['Role']['description']); ?>&nbsp;</td>
								<td class="text-center"><?php echo h($d['Role']['ordem']); ?>º&nbsp;</td>
								<td class="text-center">
								<?php
									$label_status = ($d['Role']['status'])? 'label-default' : 'label-danger';
									echo $this->Html->tag('span',
										$this->Formata->status($d['Role']['status']),
								...
								<?php
									...
									$menu = array(
										$ico_list.__('Detalhes') => array('tipo'=>'link', 'url'=>array('controller'=>'roles', 'action'=>'view', $id)),
