(function (factory) {
	...
	function CropAvatar($element) {
		...
		this.$avatarContatoId = this.$avatarForm.find('.avatar-contato_id');
  ...
  CropAvatar.prototype = {
	...
	submitDone: function (data) {
		...
		if ($.isPlainObject(data) && data.state === 200) {
			if (data.result) {
				...
				this.$avatarId.val(data.id);
				this.$avatarContatoId.val(data.contato_id);
	...
	$(function () {
		return new CropAvatar($('#crop-avatar0'));
	});
